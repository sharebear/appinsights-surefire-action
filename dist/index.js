...
(function() {
  ...
  NodeType = __webpack_require__(394);
...
const parser_1 = __importDefault(__webpack_require__(267));
function run() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const globber = yield glob.create(core.getInput('report_paths'), globOptions);
            try {
                for (var _b = __asyncValues(globber.globGenerator()), _c; _c = yield _b.next(), !_c.done;) {
                    const file = _c.value;
                    const data = yield fs.promises.readFile(file);
                    const result = yield (0, parser_1.default)(data);
...
(function() {
  ...
  parser = __webpack_require__(314);

  processors = __webpack_require__(236);
...
Object.defineProperty(exports, "__esModule", { value: true });
const xml2js_1 = __webpack_require__(189);
const zod_1 = __webpack_require__(301);
const TestCase = zod_1.z.object({
    $: zod_1.z.object({
        name: zod_1.z.string(),
    ...
    error: zod_1.z.array(zod_1.z.object({})).optional(),
    failure: zod_1.z.array(zod_1.z.object({})).optional(),
    skipped: zod_1.z.array(zod_1.z.object({})).optional()
});
const TestSuite = zod_1.z.object({
    testcase: zod_1.z.array(TestCase)
});
const SurefireTestReport = zod_1.z.object({
    testsuite: TestSuite
});
const parseSurefireTime = (input) => {
...
const parseSurefireXML = (input) => __awaiter(void 0, void 0, void 0, function* () {
    const xmlAsJson = yield (0, xml2js_1.parseStringPromise)(input);
    const parsedJson = SurefireTestReport.parse(xmlAsJson);
    return parsedJson.testsuite.testcase.map((tc) => {
        return {
...
exports.default = parseSurefireXML;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.z = void 0;
var z = __importStar(__webpack_require__(906));
exports.z = z;
...
(function() {
  ...
  XMLCharacterData = __webpack_require__(709);
...
var errorUtil_1 = __webpack_require__(513);
var parseUtil_1 = __webpack_require__(888);
var util_1 = __webpack_require__(985);
var PseudoPromise_1 = __webpack_require__(169);
var ZodError_1 = __webpack_require__(892);
...
(function() {
  ...
  builder = __webpack_require__(958);
...
(function() {
  ...
  ref = __webpack_require__(229), isObject = ref.isObject, isFunction = ref.isFunction, isPlainObject = ref.isPlainObject, getValue = ref.getValue;
  ...
  WriterState = __webpack_require__(766);
...
(function() {
  ...
  ref = __webpack_require__(229), isObject = ref.isObject, isFunction = ref.isFunction, getValue = ref.getValue;
  ...
  XMLNamedNodeMap = __webpack_require__(361);
...
(function() {
  ...
  XMLDOMErrorHandler = __webpack_require__(744);
...
(function() {
  ...
  ref1 = __webpack_require__(229), isObject = ref1.isObject, isFunction = ref1.isFunction, isEmpty = ref1.isEmpty, getValue = ref1.getValue;
  ...
  module.exports = XMLNode = (function() {
    function XMLNode(parent1) {
      ...
      if (!XMLElement) {
        ...
        XMLText = __webpack_require__(318);
        XMLProcessingInstruction = __webpack_require__(939);
        XMLDummy = __webpack_require__(590);
        NodeType = __webpack_require__(394);
        XMLNodeList = __webpack_require__(768);
        XMLNamedNodeMap = __webpack_require__(361);
        DocumentPosition = __webpack_require__(839);
      }
    }
...
(function() {
  ...
  XMLDOMImplementation = __webpack_require__(310);

  XMLDOMConfiguration = __webpack_require__(465);
...
(function() {
  ...
  assign = __webpack_require__(229).assign;
